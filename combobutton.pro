...
UBUNTU_TRANSLATION_DOMAIN="combobutton.liu-xiao-guo"
...
aptest.commands = bash $$PWD/combobutton/tests/autopilot/run
aptest.depends  = sub-combobutton

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/combobutton/tests/unit
unittest.depends  = sub-combobutton
